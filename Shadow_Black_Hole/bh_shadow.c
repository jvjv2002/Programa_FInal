...
int main(void){
    ...
    const size_t Nx = 100;
    const size_t Ny = 100;
    const double x_interval = 10.0; // -10 -> 10
    const double y_interval = 10.0; // 10 -> 10
    ...
    __uint8_t* shadow = (__uint8_t*) malloc(N*sizeof(__uint8_t));
